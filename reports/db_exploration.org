...
#+TITLE: Exploration of variables 2010
#+OPTIONS: ^:{}
...
SELECT time_study_1min AS time_study,
  ...
  heave_avg as heave
FROM amundsen_flux.navigation_1min_2010
"""
...
As measured by POSMV instrument on the ship.
...
FROM amundsen_flux.meteorology_ceos_1min_2010
"""
...
qry="""
  SELECT time_study_1min as time_study,
  atmospheric_pressure_avg as atmospheric_pressure,
  air_temperature_avg as air_temperature,
  relative_humidity_avg as relative_humidity,
  surface_temperature_avg as surface_temperature,
  wind_speed_avg as wind_speed,
  wind_direction_avg as wind_direction
  FROM amundsen_flux.meteorology_avos_1min_2010
  """
...
FROM amundsen_flux.radiation_1min_2010
"""
...
FROM amundsen_flux.motion_10hz_2010
...
FROM amundsen_flux.wind3d_analog_1min_2010
"""
...
SELECT time_study_1min as time_study,
  ...
  air_temperature_sonic_avg AS air_temperature_sonic,
  sound_speed_avg AS sound_speed
FROM amundsen_flux.wind3d_serial_1min_2010
"""
wind3d=pd.read_sql(qry, conn, parse_dates=['time_study'],
                   index_col="time_study")
wind3d[['wind_speed_u']].plot(ax=axs[0], legend=False)
...
SELECT time_study,
  ...
  op_bandwidth,
  op_delay_interval
FROM amundsen_flux.opath1_1min_2010
"""
...
SELECT time_study,
  ...
  cp_temperature_cell,
  cp_temperature_out
FROM amundsen_flux.cpath_1min_2010
"""
...
FROM amundsen_flux.cpath_10hz_2010
GROUP BY 1
"""
cpath=pd.read_sql(qry, conn, parse_dates=['time_study'],
                  index_col="time_study")
...
FROM amundsen_flux.underway_1min_2010;
  """
